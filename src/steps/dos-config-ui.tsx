...
import {
    ...
    DosConfigValue,
    DosConfig,
} from "emulators/dist/types/dos/bundle/dos-conf";
...
export function DosConfigUi(props: { config: DosConfig }) {
    const config = props.config;
    return <div>
        <Category category={config.dosbox}
            localizedDescription={t("dosbox_config")}></Category>
        <br /><br />
        <Category category={config.cpu}
            localizedDescription={t("cpu_config")}></Category>
        <br /><br />
        <Category category={config.output}
            localizedDescription={t("output_config")}></Category>
        <br /><br />
        <Category category={config.mixer}
            localizedDescription={t("mixer_config")}></Category>
        <br /><br />
        <Category category={config.autoexec}
            localizedDescription={t("autoexec_config")}></Category>
        <br /><br />
    </div>;
}

function Category(props: {
    category: DosConfigCategory,
    ...
    const options = [];
    for (const option of Object.keys(category.options)) {
        options.push(<RenderOption option={category.options[option]} />);
    }
